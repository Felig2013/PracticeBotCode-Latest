...
import org.team4230.ScaleBot.OI;
...
public class DriveTrain extends Subsystem {
    ...
    public void drive(double speed, double rotation, double mod) {
        double spd = confSpd.getDouble(0.85);
        double rot = confRot.getDouble(0.65);
        drive.arcadeDrive(speed*spd*-1*mod, rotation*rot*-1*(mod+0.4),true);
    }
